    ...
    config.vm.define boxname do |box|
        ...
        when "centralRouter"
          box.vm.provision "shell", run: "always", inline: <<-SHELL
            ...
            echo "192.168.1.0/24 via 192.168.255.11 dev eth5" >> /etc/sysconfig/network-scripts/route-eth5
            echo "192.168.2.0/24 via 192.168.255.10 dev eth5" >> /etc/sysconfig/network-scripts/route-eth5
